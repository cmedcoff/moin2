...
class Config(DefaultConfig):
    ...
    admin_emails = ['cmedcoff@hotmailcom']
    ...
    acls = {
        ...
        NAMESPACE_DEFAULT: dict(before='admin:read,write,create,destroy,admin',
                                default='TrustedEditorGroup:read,write,create All:read',
                                after='',
                                hierarchic=False, ),
        # user home pages should be stored here
        NAMESPACE_USERS: dict(before='admin:read,write,create,destroy,admin',
                              default='TrustedEditorGroup:read,write,create All:read',
                              after='',
